 ...
 <div class="container">
        <h1 class="about-title">Program Belajar</h1>
        <p class="about-sub-title">Program Belajar Pondok Pesantren Daaru Hiraa</p>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 wow fadeIn" data-wow-duration="2s" data-wow-delay=".1s">
                <div class="service-box2">
                    ...
                    <h3><a href="#">Hafidz Al-Qur'an</a></h3>
