    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                ...
                <a href="/">
                        @if (@$footer->logo == NULL)
                        <img class="img-responsive" style="width: 100px; height: auto;"
                            src="{{asset('Assets/Frontend/img/logo-footer.png')}}" alt="logo">
                        @else
                        <img class="img-responsive" style="width: 100px; height: auto;"
                            src="{{asset('storage/images/logo/' .$footer->logo)}}" alt="logo">
                        @endif
                    </a>
